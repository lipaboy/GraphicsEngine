...
public:
	...
	virtual void Init()
	{
		...
		// Object #1 - Plane with sand texture (Point filter)
		{
            ...
            pObject1->m_pTransform	= new Transform( -0.600,0,0, 90,0,0, 0.2,10,1 );
        ...
        // Object #1 - Plane with sand texture (Point filter)
        {
            ...
            pObject1->m_pTransform	= new Transform( -0.175,0,0, 90,0,0, 0.2,10,1 );
            pObject1->m_pMesh		= new MeshQuad();
        ...
        // Object #1 - Plane with sand texture (Point filter)
        {
            ...
            pObject1->m_pTransform	= new Transform( 0.275,0,0, 90,0,0, 0.2,10,1 );
            pObject1->m_pMesh		= new MeshQuad();
        ...
        // Object #1 - Plane with sand texture (Point filter)
        {
            ...
            pObject1->m_pTransform	= new Transform( 0.700,0,0, 90,0,0, 0.2,10,1 );
            pObject1->m_pMesh		= new MeshQuad();
