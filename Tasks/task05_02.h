...
#include "GraphicsEngine/Materials/MaterialTask05_2.h"
...
public:
    ...
    virtual void Init()
    {
        ...
        // Object #1 - Plane with sand texture (Point filter)
        {
            ...
            pObject1->m_pTransform	= new Transform( 0,0,0, 90,0,0, 1,10,1 );
            pObject1->m_pMesh		= new MeshQuad();
            pObject1->m_pMaterial	= new MaterialTask05_2(TEXTURE_FILTER_MODE_ANISOTROPIC);
